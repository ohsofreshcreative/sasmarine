...
<section
	...
	@class([ 'b-solutions relative bg-secondary-lighter -smt' ,
	...
	<div class="c-main section-py">
		...
		<div class="__wrapper relative z-20">
					@if (!empty($solutions['title']))
			<div data-gsap-element="title" class="c-title">
				{{ $solutions['title'] }}
					</div> 
			@endif
				@if (!empty($solutions_title))
			<h2 class="text-primary">{{ $solutions_title }}</h2>
		</div>
		@endif
		<div class="swiper solutions-standard relative !overflow-visible z-20 mt-14">
